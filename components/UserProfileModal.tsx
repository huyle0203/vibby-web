...
export default function UserProfileModal({ isVisible, onClose, user }: UserProfileModalProps) {
  ...
  return (
    ...
    >
      <div
        className={`fixed bottom-0 left-0 right-0 max-h-[85vh] w-full max-w-md mx-auto overflow-y-auto hide-scrollbar bg-black border border-[#3A93FA] rounded-t-xl transition-transform duration-300 ease-out ${
